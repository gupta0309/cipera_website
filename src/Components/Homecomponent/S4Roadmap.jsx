  ...
  return (
    <section className="cpr-roadmap-section" onMouseEnter={() => setIsPaused(true)} onMouseLeave={() => setIsPaused(false)}>
      ...
      <div className="cpr-roadmap-viewport">
        <button className="cpr-nav-btn cpr-prev" onClick={() => handleManualScroll('left')}>&lt;</button>
        ...
        <button className="cpr-nav-btn cpr-next" onClick={() => handleManualScroll('right')}>&gt;</button>
      </div>
